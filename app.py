...
def main():
    settings = Settings(
        ...
        analyzer_id="Statement",
        # Insert the supported file types of the analyzer.
        file_location="https://github.com/bosh345/ddoc/blob/4a7f821a9e4c310cdebfc0fe29d7726fcf6e023d/Transcript%203.pdf",
    )
...
class Settings:
    ...
    def __post_init__(self):
        key_not_provided = (
            ...
            or self.subscription_key == "4MytYG6tDJp5p3WbMmWXmGm22j3NyKzgSCMvKrHCj3UEzwn9KPD6JQQJ99BEACfhMk5XJ3w3AAAAACOGTnyc"
        )
        token_not_provided = (
            not self.aad_token
